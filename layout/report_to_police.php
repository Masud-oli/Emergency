<title><?php if(isset($_SESSION['bn'])){echo $reportPoliceTitle2;}else{echo $reportPoliceTitle;}?></title>
<?php
...
<div class="container">
		...
		<div class="panel panel-primary">
      				<div class="panel-heading" style="text-align:center; font-size:24px"><?php if(isset($_SESSION['bn'])){echo $QuickContacttoPolice2;}else{echo $QuickContacttoPolice;}?></div>
      				<div class="panel-body">
                    <form id="form3" name="f" method="post" action="report_insert/insert_police_info_reporter.php" onSubmit="return validateForm_rab();"  enctype="multipart/form-data">
                     	...
                     	<legend><?php if(isset($_SESSION['bn'])){echo $selectDivisionName2;}else{echo $selectDivisionName;}?><span style="color:red">*</span></legend>
                            <div class="form-group">
                                ...
                                <option value="" selected hidden><?php if(isset($_SESSION['bn'])){echo $selectDivision2;}else{echo $selectDivision;}?></option>
                                 ...
                                 <div class="form-group">
                                 <select class="form-control" name="districtName" id="districtName"  onChange="callUpazilla2()">
