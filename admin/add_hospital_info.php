			...
			<div class="col-md-4 stats-info">
              <br>
               <div class="panel panel-info">
      				<div class="panel-heading" style="text-align:center">Hospital Information Add Form</div>
      				<div class="panel-body">
                    <form id="form3" name="myForm" method="post" action="insert/insert_hospital_info.php" onSubmit="return validateForm_hospital();"  enctype="multipart/form-data">
                    <legend>Select Division Name<span style="color:red">*</span></legend>                            
    					...
    					<legend>Hostipal Title Name<span style="color:red">*</span></legend>                            
                             <div class="form-group">
                                <input type="text" class="form-control" placeholder="example- Rangpur Medical..." name="hospital_title" />
                              </div>
