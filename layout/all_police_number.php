<title><?php if(isset($_SESSION['bn'])){echo $viewPoliceNumberTitle2;}else{echo $viewPoliceNumberTitle;}?></title>
<?php
...
xmlhttp.open("GET","layout/get_police_info.php?q="+str,true);
xmlhttp.send();
}
</script> 
...
<div class="container">
		...
		<div class="panel panel-info">
      				<div class="panel-heading" style="text-align:center"><h3><?php if(isset($_SESSION['bn'])){echo $policeNumbertitle2;}else{echo $policeNumbertitle;}?></h3></div>
                    ...
                    <form id="form3" name="f" method="post" action="report_insert/insert_rab_info_reporter.php" onSubmit="return validateForm_rab();"  enctype="multipart/form-data">
                      ...
                      <legend><?php if(isset($_SESSION['bn'])){echo $selectDivisionName2;}else{echo $selectDivisionName;}?><span style="color:red">*</span></legend>
                            <div class="form-group">
                                <select class="form-control" id="divisionName" name="divisionName" onchange="callCourses2()">
                                <option value="" selected hidden><?php if(isset($_SESSION['bn'])){echo $selectDivision2;}else{echo $selectDivision;}?></option>
                               	<?php
										include('db_con.php');
						
										$resource=mysql_query("SELECT *FROM police_info_table GROUP BY divisionName");
        ...
        <div class="col-md-8 left-part">
                        <?php echo"<div id='txtHint'><b><font face='verdana' size='2px' color='navy'>"?><?php if(isset($_SESSION['bn'])){echo $listPolice2;}else{echo $listPolice;}?> <?php echo "</font></b></div>";?>
        </div>
        <div class="col-md-4 left-part">
