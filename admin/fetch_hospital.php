...
$sql="SELECT * FROM fire_service_info_report_table WHERE reporterMobileNo LIKE '%".$_POST["search"]."%' OR upazillaName LIKE '%".$_POST["search"]."%' OR action_title LIKE '%".$_POST["search"]."%' OR districtName LIKE '%".$_POST["search"]."%' OR divisionName LIKE '%".$_POST["search"]."%' OR date_time LIKE '%".$_POST["search"]."%'";
