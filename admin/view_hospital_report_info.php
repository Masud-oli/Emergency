...
include('db_con.php'); 
$limit = 6;  
$sql = "SELECT COUNT(id) FROM  hospital_info_report_table";  
...
if (isset($_GET["hospital_page"]))
{
  $cPage=$_GET["hospital_page"];
   $one=6*$cPage-5;
    $two=$one+5;
...
?>
  ...
  <div class="row">
    <div class="col-md-8">
<?php
if (isset($_GET["hospital_page"])) { $page  = $_GET["hospital_page"]; } else { $page=1; };  
$start_from = ($page-1) * $limit;  

$sql = "SELECT * FROM  hospital_info_report_table ORDER BY id DESC LIMIT $start_from, $limit";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='action_index.php?hospital_page=".$i."'>".$i."</a></li>";  
};  
  echo $pagLink . "</ul></nav>"; 
              ...
              <td style="text-align:center;  padding-top: 45px">
               <?php if($row[13]==2) 
                 { 
                  ...
                  ?>
              <?php
              echo "<a target='_blank'  href='print_action_hospital.php?id=".$row[0]."' title='Print' role='button'> <i class='glyphicon glyphicon-print'></i></a>";
              ?>
                  ...
                  <div class="modal-dialog modal-lg">            
                      ...
                      <div class="modal-content">
                        <div class="modal-header sm-primary">
                          ...
                          <h2 style="text-align:center"><span style="font-size:23px" class="glyphicon glyphicon-th"></span>Hospital Details Information</h2>                                   
                        </div>
                                  ...
                                  <input type="text" readonly class="form-control" value="<?php echo $row[2] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                    ...
                                    <div class="col-sm-4"><br>
                                       <div class="form-group has-success has-feedback">
                                              ...
                                              <input type="text" readonly class="form-control" value="<?php echo $row[7] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                              </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        <div class="input-group">
                                        <span class="input-group-addon">Hospitals Name &nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    ...
                                    <div class="col-sm-4"><br>
                                        ...
                                        <div class="form-group has-success has-feedback">
                                        <div class="input-group">
                                        <span class="input-group-addon">Hospital Mob. </span>
                                    ...
                                    <div class="col-sm-4"><br>
                                        ...
                                        <textarea class="form-control" rows="2" cols="6" ><?php echo $row[12] ?></textarea>
                                        </div>
                                     ...
                                     <div class="col-sm-6"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        ...
                                        <textarea class="form-control" rows="4" cols="10" readonly><?php echo $row[8] ?></textarea>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-sm-6"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        ...
                                        <textarea class="form-control" rows="4" cols="10" readonly><?php echo $row[14] ?></textarea>
                                        </div>
                                      </div>
                                    </div>
                  ...
                  <div class="alertify">            
                      ...
                      <div class="modal-content">
                        <div class="modal-body messages">
                              ...
                              <a href="delete/delete_hospital_info.php?id=<?php echo $row[0]?>"><button class="alertify-button alertify-button-ok" id="alertify-ok">OK</button></a></nav>
                  ...
                  <div class="alertify">            
                      ...
                      <div class="modal-content">
                        <div class="modal-body messages">
                              ...
                              <nav class="alertify-buttons" style="text-align:center">
                              <button class="alertify-button alertify-button-cancel" data-dismiss="modal">Cancel</button>
                              <a href="successActionHospital.php?id=<?php echo $row[0]?>"><button class="alertify-button alertify-button-ok" id="alertify-ok">OK</button></a></nav>
...
$('.pagination').pagination({
    ...
    hrefTextPrefix : 'action_index.php?hospital_page='
    });
  });
</script> 
