...
<html>
<head>
<title>RAB Action Print Copy</title>
...
<?php
include('db_con.php'); 
$sql="SELECT * FROM rab_info_report_table WHERE id='".$_GET['id']."'";
                                  ...
                                  <input type="text" readonly class="form-control" value="<?php echo $data['divisionName'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                    ...
                                    <div class="col-sm-4"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        ...
                                        <input type="text" readonly class="form-control" value="<?php echo $data['rab_title'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-sm-4"><br>
                                        ...
                                        <input type="text" readonly class="form-control" value="<?php echo $data['rab_mobileNo'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-sm-4"><br>
