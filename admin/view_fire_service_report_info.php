...
include('db_con.php'); 
$limit = 6;  
$sql = "SELECT COUNT(id) FROM fire_service_info_report_table";  
...
if (isset($_GET["fire_service_page"]))
{
  $cPage=$_GET["fire_service_page"];
   $one=6*$cPage-5;
    $two=$one+5;
...
?>
  ...
  <div class="row">
    <div class="col-md-8">
<?php
if (isset($_GET["fire_service_page"])) { $page  = $_GET["fire_service_page"]; } else { $page=1; };  
$start_from = ($page-1) * $limit;  

$sql = "SELECT * FROM fire_service_info_report_table ORDER BY id DESC LIMIT $start_from, $limit";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='action_index.php?fire_service_page=".$i."'>".$i."</a></li>";  
};  
  echo $pagLink . "</ul></nav>"; 
              ...
              <td style="text-align:center;  padding-top: 45px">
               <?php if($row[12]==2) 
                 ...
                 {?>
                  ...
                  ?>
              <?php
              echo "<a target='_blank'  href='print_action_fire_service.php?id=".$row[0]."' title='Print' role='button'> <i class='glyphicon glyphicon-print'></i></a>";
              ?>
                  ...
                  <div class="modal-dialog modal-lg">            
                      ...
                      <div class="modal-content">
                        <div class="modal-header sm-primary">
                          ...
                          <h2 style="text-align:center"><span style="font-size:23px" class="glyphicon glyphicon-th"></span> Fire Service Details Information</h2>                                   
                        </div>
                                ...
                                <div class="row">
                                  ...
                                  <input type="text" readonly class="form-control" value="<?php echo $row[2] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                    ...
                                    <div class="col-sm-4"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        <div class="input-group">
                                        <span class="input-group-addon">Fire Service Title &nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    ...
                                    <div class="col-sm-4"><br>
                                        ...
                                        <div class="form-group has-success has-feedback">
                                        <div class="input-group">
                                        <span class="input-group-addon">F_Service Mob. </span>
                  ...
                  <div class="alertify">            
                      ...
                      <div class="modal-content">
                        <div class="modal-body messages">
                              ...
                              <a href="delete/delete_fire_service_info.php?id=<?php echo $row[0]?>"><button class="alertify-button alertify-button-ok" id="alertify-ok">OK</button></a></nav>
                  ...
                  <div class="alertify">            
                      ...
                      <div class="modal-content">
                        <div class="modal-body messages">
                              ...
                              <nav class="alertify-buttons" style="text-align:center">
                              <button class="alertify-button alertify-button-cancel" data-dismiss="modal">Cancel</button>
                              <a href="successActionFireService.php?id=<?php echo $row[0]?>"><button class="alertify-button alertify-button-ok" id="alertify-ok">OK</button></a></nav>
...
$('.pagination').pagination({
    ...
    hrefTextPrefix : 'action_index.php?fire_service_page='
    });
  });
</script> 
