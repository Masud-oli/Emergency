<title><?php if(isset($_SESSION['bn'])){echo $viewRabNumberTitle2;}else{echo $viewRabNumberTitle;}?></title>
<?php
...
xmlhttp.open("GET","layout/get_rab_info.php?q="+str,true);
xmlhttp.send();
}
</script> 
...
<div class="container">
		...
		<div class="panel panel-info">
      				<div class="panel-heading" style="text-align:center"><h3><?php if(isset($_SESSION['bn'])){echo $rabNumbertitle2;}else{echo $rabNumbertitle;}?></h3></div>
                    ...
                    <form id="form3" name="f" method="post" action="report_insert/insert_rab_info_reporter.php" onSubmit="return validateForm_rab();"  enctype="multipart/form-data">
                      ...
                      <legend><?php if(isset($_SESSION['bn'])){echo $selectDivisionName2;}else{echo $selectDivisionName;}?><span style="color:red">*</span></legend>
                            <div class="form-group">
                                <select class="form-control" id="divisionName" name="divisionName" onchange="callCourses()">
        ...
        <div class="col-md-8 left-part">
                         <?php echo"<div id='txtHint'><b><font face='verdana' size='2px' color='navy'>"?><?php if(isset($_SESSION['bn'])){echo $listRab2;}else{echo $listRab;}?> <?php echo "</font></b></div>";?>
        </div>
        <div class="col-md-4 left-part">
