<title><?php if(isset($_SESSION['bn'])){echo $reportRabTitle2;}else{echo $reportRabTitle;}?></title>
<?php
...
<div class="container">
		...
		<div class="panel panel-primary">
      				<div class="panel-heading" style="text-align:center; font-size:26px"><?php if(isset($_SESSION['bn'])){echo $QuickContacttoRAB2;}else{echo $QuickContacttoRAB;}?></div>
