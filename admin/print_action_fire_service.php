...
<html>
<head>
<title>Fire Service Action Print Copy</title>
...
<?php
include('db_con.php'); 
$sql="SELECT * FROM fire_service_info_report_table WHERE id='".$_GET['id']."'";
                                  ...
                                  <input type="text" readonly class="form-control" value="<?php echo $data['divisionName'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                    ...
                                    <div class="col-sm-4"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        ...
                                        <input type="text" readonly class="form-control" value="<?php echo $data['fire_service_info_title'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-sm-4"><br>
                                        ...
                                        <div class="form-group has-success has-feedback">
                                        <div class="input-group">
                                        <span class="input-group-addon">Fire Service Mob.: &nbsp;&nbsp;&nbsp;</span>
                                        <input type="text" readonly class="form-control" value="<?php echo $data['fire_service_mobileNo'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-sm-4"><br>
