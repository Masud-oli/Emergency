...
include('db_con.php'); 
$limit = 10;  
$sql = "SELECT COUNT(id) FROM upazilla_table";  
...
if (isset($_GET["upazilla_page"]))
{
  $cPage=$_GET["upazilla_page"];
   $one=10*$cPage-9;
    $two=$one+9;
...
?>
  ...
  <div class="row">
    <div class="col-md-8">
<?php
if (isset($_GET["upazilla_page"])) { $page  = $_GET["upazilla_page"]; } else { $page=1; };  
$start_from = ($page-1) * $limit;  

$sql = "SELECT * FROM upazilla_table ORDER BY divisionName DESC LIMIT $start_from, $limit";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='action_index.php?upazilla_page=".$i."'>".$i."</a></li>";  
};  
  echo $pagLink . "</ul></nav>"; 
                  ...
                  <div class="alertify">            
                      ...
                      <div class="modal-content">
                        <div class="modal-body messages">
                              ...
                              <a href="delete/deleteUpazilla.php?id=<?php echo $row[0]?>"><button class="alertify-button alertify-button-ok" id="alertify-ok">OK</button></a></nav>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'action_index.php?upazilla_page='
    });
	});
</script>	
