...
include('db_con.php'); 
$limit = 10;  
$sql = "SELECT COUNT(id) FROM rab_info_table";  
...
if (isset($_GET["rab_info_page"]))
{
  $cPage=$_GET["rab_info_page"];
   $one=10*$cPage-9;
    $two=$one+9;
...
?>
  ...
  <div class="row">
    <div class="col-md-8">
<?php
if (isset($_GET["rab_info_page"])) { $page  = $_GET["rab_info_page"]; } else { $page=1; };  
$start_from = ($page-1) * $limit;  

$sql = "SELECT * FROM  rab_info_table ORDER BY divisionName DESC LIMIT $start_from, $limit";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li><a href='action_index.php?rab_info_page=".$i."'>".$i."</a></li>";  
};  
  echo $pagLink . "</ul></nav>"; 
          ...
          <th style="text-align:center">Division Name</th>
           <th style="text-align:center">District Name</th>
            <th style="text-align:center">UpaZilla Name</th>
             <th style="text-align:center">RAB Title</th>
                  ...
                  <div class="alertify">            
                      ...
                      <div class="modal-content">
                        <div class="modal-body messages">
                              ...
                              <a href="delete/delete_rab_info2.php?id=<?php echo $row[0]?>"><button class="alertify-button alertify-button-ok" id="alertify-ok">OK</button></a></nav>
...
$('.pagination').pagination({
		...
		hrefTextPrefix : 'action_index.php?rab_info_page='
    });
	});
</script>	
