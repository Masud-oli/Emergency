			...
			<div class="col-md-4 stats-info">
              <br>
               <div class="panel panel-info">
      				<div class="panel-heading" style="text-align:center">RAB Information Add Form</div>
      				<div class="panel-body">
                    <form id="form3" name="myForm" method="post" action="insert/insert_rab_info.php" onSubmit="return validateForm_rab();"  enctype="multipart/form-data">
                    <legend>Select Division Name<span style="color:red">*</span></legend>                            
    					...
    					<legend>RAB Title Name<span style="color:red">*</span></legend>                            
                             <div class="form-group">
                                <input type="text" class="form-control" placeholder="example- RAB-13..." name="rab_title" />
                              </div>
