<title><?php if(isset($_SESSION['bn'])){echo $viewHospitalNumberTitle2;}else{echo $viewHospitalNumberTitle;}?></title>
<?php
...
xmlhttp.open("GET","layout/get_hospital_info.php?q="+str,true);
xmlhttp.send();
}
</script> 
...
<div class="container">
		...
		<div class="panel panel-info">
      				<div class="panel-heading" style="text-align:center"><h3><?php if(isset($_SESSION['bn'])){echo $hospitalNumbertitle2;}else{echo $hospitalNumbertitle;}?></h3></div>
      				<div class="panel-body">
                    <form id="form3" name="f" method="post" action="#" onSubmit="return validateForm_rab();"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <option value="" selected hidden><?php if(isset($_SESSION['bn'])){echo $selectDivision2;}else{echo $selectDivision;}?></option>
                               	<?php
										...
										$resource=mysql_query("SELECT *FROM hospital_info_table GROUP BY divisionName");
        ...
        <div class="col-md-8 left-part">
                       <?php echo"<div id='txtHint'><b><font face='verdana' size='2px' color='navy'>"?><?php if(isset($_SESSION['bn'])){echo $listHospital2;}else{echo $listHospital;}?> <?php echo "</font></b></div>";?>
        </div>
        <div class="col-md-4 left-part">
