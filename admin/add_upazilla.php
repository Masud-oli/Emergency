			...
			<div class="col-md-4 stats-info">
              <br>
               <div class="panel panel-info">
      				<div class="panel-heading" style="text-align:center">Upazilla Add Form</div>
      				<div class="panel-body">
                    <form id="form3" name="myForm" method="post" action="insert/insert_upazilla.php" onSubmit="return validateForm_police();"  enctype="multipart/form-data">
                    <legend>Select Division Name<span style="color:red">*</span></legend>                            
    					...
    					<legend>Upazilla Name<span style="color:red">*</span></legend>                            
                             <div class="form-group">
                                <input type="text" class="form-control" placeholder="Upazilla name input here." name="upazillaName" />
                              </div>
