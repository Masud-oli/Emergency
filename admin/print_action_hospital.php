...
<html>
<head>
<title>Hospital Action Print Copy</title>
...
<?php
include('db_con.php'); 
$sql="SELECT * FROM hospital_info_report_table WHERE id='".$_GET['id']."'";
                                  ...
                                  <input type="text" readonly class="form-control" value="<?php echo $data['divisionName'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                    ...
                                    <div class="col-sm-4"><br>
                                       ...
                                       <div class="form-group has-success has-feedback">
                                        ...
                                        <input type="text" readonly class="form-control" value="<?php echo $data['hospital_info_title'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-sm-4"><br>
                                        ...
                                        <input type="text" readonly class="form-control" value="<?php echo $data['hospital_mobileNo'] ?>" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-sm-4"><br>
